#!/usr/bin/env python3
"""Generation-time SAE intervention on GDN recurrent states.

At every autoregressive step, intercept the recurrent state at a target
(layer, head), encode through a bilinear SAE, scale specific feature
activations, decode back, and patch the modified state into the cache.
Generate 200 tokens per prompt across 100 prompts, then measure
document-level statistics across baseline / boost / suppress conditions.
"""
