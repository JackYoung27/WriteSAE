...
pure GLA (Gated Linear Attention) models.  Uses fla-hub/delta_net-1.3B-100B,
...
image = (
    ...
    .env({"MATRIX_SAE_CODE_SHA": CODE_SHA, "_CACHE_BUST": "dn1"})
)

app = modal.App("deltanet-validation")
vol = modal.Volume.from_name("deltanet-validation-data", create_if_missing=True)
